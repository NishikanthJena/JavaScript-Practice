...
//     }
// }else {
//     console.log(`You are not eligible to vote (you're under 18 years)`);
// }
...
//     case `Sunday`:
//         console.log(`Today is Sunday, Let's Partyyyy...`);   
//         break;
...
// let l = 5;      // Global Variable in this -> Rectangle & Square can access it
// let b = 10;     // Global Variable in this -> Rectangle & Square can access it
// let result;
// switch (areaOfShapes) {
//     case `Rectangle`:
//         result = l * b;
...
//     default:
//         console.log(`None of the shape matched`);    
// }
...
// let num = 1;
// while(num <= 10){
//     console.log(`5 * `+ num + ` = ` + (5 * num));      //(or)  console.log(`5 * ${num} = ${5 * num}`);
//     num++;
// }
...
// console.log(`You've entered a valid positive number: `, positiveNumber);
