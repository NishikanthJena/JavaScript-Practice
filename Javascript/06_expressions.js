...
// When you divide String by number?
...
// age > 18
// age == 18
// He/She haveDrivingLicense or not )
...
//! Q: Let say you have a variable score representing a student's exam score. If the score is greater than or equal to 60, then the student passes; otherwise, they fail. Use the conditional (ternary) operator to determine the result and store it in a variable called result. Log the result to the console❓

// let score = 60;
// let result = score >= 60 ? `Yes` : `No`;
// console.log(result);
